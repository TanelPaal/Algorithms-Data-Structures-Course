...
public class QuaternionTest {
   ...
   public void testPowZero() {
      ...
      assertEquals(new Quaternion(1, 0, 0, 0), result);
   }
   ...
   @Test
   public void testPowNegativeOne() {
      Quaternion q = new Quaternion(1, 2, 3, 4);
      Quaternion result = q.pow(-1);
      assertEquals(q.inverse(), result);
   }
   ...
   public void testPowNegative() {
      Quaternion q = new Quaternion(1, 2, 3, 4);
      Quaternion result = q.pow(-2);
      assertEquals(q.pow(2).inverse(), result);
   }

   @Test(expected = ArithmeticException.class)
   public void testPowNegativeZeroQuaternion() {
